...
<div class="page-content">
    <!-- Section Banner -->
    <div class="dez-bnr-inr dez-bnr-inr-md" style="background-image:url({{asset('user1/images/main-slider/slide2.jpg')}});">
        <div class="container">
            <div class="dez-bnr-inr-entry align-m ">
                <div class="find-job-bx">
                    ...
                    <form class="dezPlaceAni" action="{{ route('search') }}" method="post" class="search-box"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-md-6 m-b30">
                    <div class="city-bx align-items-end  d-flex" style="background-image:url({{asset('user1/images/city/pic1.jpg')}})">
                        <div class="city-info">
                            <h5>Iraq</h5>
                            <span>765 Jobs</span>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 m-b30">
                    <div class="city-bx align-items-end  d-flex" style="background-image:url({{asset('user1/images/city/pic2.jpg')}})">
                        <div class="city-info">
                            <h5>Argentina</h5>
                            <span>352 Jobs</span>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 m-b30">
                    <div class="city-bx align-items-end  d-flex" style="background-image:url({{asset('user1/images/city/pic3.jpg')}})">
                        <div class="city-info">
                            <h5>Indonesia</h5>
                            <span>893 Jobs</span>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 m-b30">
                    <div class="city-bx align-items-end  d-flex" style="background-image:url({{asset('user1/images/city/pic4.jpg')}})">
                        <div class="city-info">
                            <h5>Gambia</h5>
                            <span>502 Jobs</span>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 m-b30">
                    <div class="city-bx align-items-end  d-flex" style="background-image:url({{asset('user1/images/city/pic5.jpg')}})">
                        <div class="city-info">
                            <h5>India</h5>
                            <span>765 Jobs</span>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 m-b30">
                    <div class="city-bx align-items-end  d-flex" style="background-image:url({{asset('user1/images/city/pic6.jpg')}})">
                        <div class="city-info">
                            <h5>Thailand</h5>
                            <span>352 Jobs</span>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 m-b30">
                    <div class="city-bx align-items-end  d-flex" style="background-image:url({{asset('user1/images/city/pic7.jpg')}})">
                        <div class="city-info">
                            <h5>Banjul</h5>
                            <span>893 Jobs</span>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 m-b30">
                    <div class="city-bx align-items-end  d-flex" style="background-image:url({{asset('user1/images/city/pic8.jpg')}})">
                        <div class="city-info">
                            <h5>Spain</h5>
                            <span>502 Jobs</span>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="m-t30">
                        <div class="d-flex">
                            <a class="site-button button-sm mr-auto" href="#"> {{ $data->links() }}</a>
                    ...
                    <div class="sticky-top">
                        <div class="candidates-are-sys m-b30">
                            <div class="candidates-bx">
                                <div class="testimonial-pic radius"><img src="{{asset('user1/images/testimonials/pic3.jpg')}}" alt=""
    ...
    <div class="section-full content-inner-2 overlay-white-middle"
        style="background-image:url({{asset('user1/images/lines.png); background-position:bottom; background-repeat:no-repeat; background-size: 100%;">
        <div class="container">
